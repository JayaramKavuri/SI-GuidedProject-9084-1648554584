...
def Vitaminact1():
   if request.method == 'POST': 
      ...
      print(reco,vara)
      if status:
       return render_template("upload.html",m1="sucess",first=vara,second=varb,third=varc,fourth=vard,fifth=vare,sixth=vark,seventh=reco)
      else:
